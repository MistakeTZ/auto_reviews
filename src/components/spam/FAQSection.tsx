...
export default function FAQSection({ t }: FAQSectionProps) {
  ...
  const faqItems = [
    {
      q: t("spamLanding.faq1Q"),
      a: t("spamLanding.faq1A"),
    },
    {
      q: t("spamLanding.faq2Q"),
      a: t("spamLanding.faq2A"),
    },
    {
      q: t("spamLanding.faq3Q"),
      a: t("spamLanding.faq3A"),
    },
    {
      q: t("spamLanding.faq4Q"),
      a: t("spamLanding.faq4A"),
    },
  ];
  ...
  return (
    <section
      id="faq"
      className="bg-white px-4 py-16 lg:px-8 lg:py-20"
    >
