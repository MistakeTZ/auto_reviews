  ...
  return (
    <header
      className={`site-header ${
        scrolled ? "scrolled" : ""
      } sticky top-0 z-[1000] w-full bg-white/95 backdrop-blur-xl border-b border-slate-100`}
    >
      <div className="header-container mx-auto flex max-w-[1200px] items-center justify-between gap-5 px-4 py-5 lg:px-8">
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm font-semibold text-slate-600">
          <a href="#scheduling" className="hover:text-indigo-600 transition-colors">
            {t("spamLanding.schedulingTag")}
          </a>
          <a href="#auto-pause" className="hover:text-indigo-600 transition-colors">
          ...
          <a href="#pricing" className="hover:text-indigo-600 transition-colors">
            {t("common.chatCampaigns") || "Pricing"}
          </a>
