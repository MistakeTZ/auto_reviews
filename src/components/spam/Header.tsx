    ...
    >
      <div className="header-container mx-auto flex max-w-[1200px] items-center justify-between gap-5 px-4 py-5 lg:px-8">
        <div className="flex items-center gap-2">
          <div className="hidden xs:flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-600 to-purple-600 shadow-lg shadow-indigo-500/30">
