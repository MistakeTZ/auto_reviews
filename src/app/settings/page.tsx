    ...
    <div className="p-8 max-w-3xl mx-auto">
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-6">
          {!apiToken ? (
            <div className="bg-orange-50 dark:bg-orange-900/20 text-orange-800 dark:text-orange-300 p-4 rounded-lg flex items-start gap-3 text-sm">
            ...
            <div className="bg-green-50 dark:bg-green-900/20 text-green-800 dark:text-green-300 p-4 rounded-lg flex items-center gap-3 text-sm">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 bg-gray-50 dark:bg-gray-900/50 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-purple-500"
                placeholder=""
              />
