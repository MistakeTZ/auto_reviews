...
from services.yookassa_service import create_yookassa_payment, verify_and_process_payment
...
async def yookassa_webhook(
    ...
    if event == "payment.succeeded":
        ...
        logger.info(f"Received YooKassa payment.succeeded webhook for payment ID: {payment_id}")
